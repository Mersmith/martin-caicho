...
class FormularioLandingLibroController extends Controller
{
    public function libro()
    {
        ...
        return view('web.landing.peru-tierra-de-incautos', compact('bloque1_1', 'bloque2_1', 'bloque4_1', 'bloque8_1', 'bloque2_2', 'bloque4_2'));
    }
